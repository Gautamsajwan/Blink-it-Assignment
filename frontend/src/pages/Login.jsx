    ...
    <div className="text-white relative w-full h-screen overflow-hidden font-montserrat flex flex-col justify-center items-center">
      <div className="mt-10 p-8 rounded-lg bg-gray-800/30">
        <form className="flex flex-col gap-2 w-[500px]">
          ...
          <button onClick={handleBack} className="mt-4 rounded-full w-fit m-auto font-bold px-10 py-2 outline outline-blue-500 hover:bg-blue-400 active:scale-95 transition duration-200 ease-in-out">Back to sign-up</button>
        </form>
      </div>
    </div>
  )
